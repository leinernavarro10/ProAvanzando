...
if($_GET['e']==1 OR $_GET['e']==2){
    ...
    $sql = "UPDATE ccostoscentro SET 
    estado = '".$_GET['e']."' 
    WHERE id = '".$_GET['id']."' ";
    $query = mysql_query($sql, $conn)or die(mysql_error());

    print "<meta http-equiv=\"refresh\" content=\"0;URL=conf-centrocostos.php?i1=".$periodo."\">";
    exit();
}
...
if (isset($_POST['nuevo'])){
    ...
    $sqlVER="SELECT * FROM ccostoscentro WHERE nombre='".$_POST['nombre']."' ";
    $queryVER=mysql_query($sqlVER,$conn)or die(mysql_error());
    if(mysql_num_rows($queryVER)==0){
      $sql3 = "INSERT INTO ccostoscentro VALUES( 
        null, 
        '".$_POST['nombre']."',
        '".$_POST['descripcion']."',
        '1'
      ...
      print "<meta http-equiv=\"refresh\" content=\"0;URL=conf-centrocostos.php?i=".$_POST['nombre']."\">";
    }else{
      print "<meta http-equiv=\"refresh\" content=\"0;URL=conf-centrocostos.php?i2=".$_POST['nombre']."\">";
    }
...
<div class="row"> 
  ...
  <div class="col-sm-7">
      ...
      <div class="panel-body" style="height: 500px;overflow-y:scroll"> 
        ...
        <?php 
          $sql="SELECT * FROM ccostoscentro ORDER BY id ASC";
              ...
              ?>
                  <tr class="hover" style="text-align: center;">
                    ...
                    <td style="text-align: center;"><?php switch ($row['estado']) {
                      case 1:
                        echo "Activo :: ";?>
                          <a href="conf-centrocostos.php?id=<?php echo $row['id']?>&e=2" class="btn btn-xs btn-red" title='Desactivar'><i class="glyphicon glyphicon-remove"></i></a>
                      <?php
                        break;
                      case 2:
                        echo "Desactivado :: ";
                        ?>
                          <a href="conf-centrocostos.php?id=<?php echo $row['id']?>&e=1" class="btn btn-xs btn-success" title='Activar'><i class="glyphicon glyphicon-ok"></i></a>
                      <?php
                        break;
                    }?>
