...
<?php $pagina="Reporte CXC"; include("../includes/header.php");?>				
...
<ol class="breadcrumb" >
	...
	<li><a href="#">Reporte de cuentas por cobrar</a></li>
</ol>
...
OPCIONES
<hr> 
<form action="../reportes/cuentasCobrar.php" method="get" target="_blank">
